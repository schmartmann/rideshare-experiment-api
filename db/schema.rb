...
ActiveRecord::Schema.define(version: 2021_01_06_190551) do
  ...
  create_table "passengers", force: :cascade do |t|
    ...
    t.string "email_address", null: false
    t.string "phone_number", null: false
    t.boolean "is_seeking", default: false, null: false
  end
  ...
  create_table "trips", force: :cascade do |t|
    ...
    t.integer "estimated_distance", default: 0, null: false
    t.integer "estimated_price", default: 0, null: false
